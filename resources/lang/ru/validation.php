...
return [
    ...
    */
    ...
    'different' => 'Поле ":attribute" должен отличаться от предыдущего значения',
    ...
    'max' => [
        ...
        'file' => 'Поле ":attribute" не должен превышать :max кб',
    ...
    'unique' => 'Поле ":attribute" с таким адресом уже существует',
